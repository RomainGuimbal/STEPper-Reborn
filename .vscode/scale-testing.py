...
bpy.ops.wm.occ_import_step(override_file="C:/Users/romai/Documents/Projets/26 - Bezier Quest/STEP samples/table plasticity.stp", lin_deflection_bl_unit = 0.5, ang_deflection = 1)
